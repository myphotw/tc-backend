...
from app.memorykeeper.routers import capture_date_cleanup as memorykeeper_capture_date_cleanup
...
protected_api_router.include_router(memorykeeper_travel.router)
...
protected_api_router.include_router(memorykeeper_capture_date_cleanup.router)
